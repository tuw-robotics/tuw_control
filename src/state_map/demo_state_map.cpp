...
int main()
{
  ...
  cout << arr.data().transpose() << endl
       << endl;
  cout << arr.sub(0).data().transpose() << endl
       << endl;
  cout << arr.sub(1).data().transpose() << endl
       << endl;
  cout << arr.sub(2).data().transpose() << endl
       << endl;
  arr.sub<0>();
  ...
  for (int i = 0; i < testDerived.sub(1).data().rows(); ++i)
  {
    testDerived.sub(1).data()(i) = 9 - i;
  }
  testDerived.sub(1).subResize(3);
  testDerived.sub(0).subResize(2);
  for (int i = 0; i < testDerived.sub(0).data().rows(); ++i)
  {
    testDerived.sub(0).data()(i) = 1 + i;
  }
  cout << endl
  ...
  for (int i = 0; i < testBaseCRTP.sub(1).data().rows(); ++i)
  {
    testBaseCRTP.sub(1).data()(i) = 9 - i;
  }
  testBaseCRTP.sub(1).subResize(3);
  testBaseCRTP.sub(0).subResize(2);
  for (int i = 0; i < testBaseCRTP.sub(0).data().rows(); ++i)
  {
    testBaseCRTP.sub(0).data()(i) = 1 + i;
  }
  cout << endl
  ...
  for (int i = 0; i < testBaseVirtual.sub(1).data().rows(); ++i)
  {
    testBaseVirtual.sub(1).data()(i) = 9 - i;
  }
  testBaseVirtual.sub(1).subResize(3);
  testBaseVirtual.sub(0).subResize(2);
  for (int i = 0; i < testBaseVirtual.sub(0).data().rows(); ++i)
  {
    testBaseVirtual.sub(0).data()(i) = 1 + i;
  }
  ...
  cout << "dataBuffer=" << bla.data().transpose() << endl;
  for (int i = 0; i < bla.sub(1).data().rows(); ++i)
  {
    bla.sub(1).data()(i) = 9 - i;
  }
  cout << "dataBuffer=" << bla.data().transpose() << endl;
  ...
  cout << "dataBuffer=" << bla.data().transpose() << endl;
  for (int i = 0; i < bla.sub(0).data().rows(); ++i)
  {
    bla.sub(0).data()(i) = 1 + i;
  }
  cout << "dataBuffer=" << bla.data().transpose() << endl;
  cout << bla.data().rows() << endl;
  cout << bla.sub(0).data().rows() << endl;
  cout << bla.sub(1).data().rows() << endl
       << endl;

  cout << bla.data() << endl
       << endl;
  cout << bla.data().transpose() << endl
       << endl;
  cout << bla.sub(0).data() << endl
       << endl;
  cout << bla.sub(1).data() << endl
       << endl;
