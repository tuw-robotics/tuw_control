...
//     statesSimExp = statesDt + /*statesDs - 2 +*/ statesLattice0 - 2; EXPECT_EQ( statesSimExp, trajSim->simLatticeSize() );//ds in same locations as dt
//     checkSimLatticeConsistency();
//     
...
//     EXPECT_EQ( sumStates, sumAllPartStates (trajSim) ); 
//     statesSimExp = statesDt + statesDs - 2 - 3 + statesLattice0 - 2; EXPECT_EQ( statesSimExp, trajSim->simLatticeSize() );//3 ds overlay in same locations with dt (.25, .5, .75)
//     checkSimLatticeConsistency();
// }
// 
// 
...
//     checkSimLatticeConsistency();
//     
//     trajSim->simulateTrajectory(0.10); checkSimLatticeConsistency();checkSimLatticeStatesEqual( trajStatesRef ); checkPartLatticeStatesEqual( partLatRef, trajSim->partLattices_ );
//     trajSim->simulateTrajectory(0.34); checkSimLatticeConsistency();checkSimLatticeStatesEqual( trajStatesRef ); checkPartLatticeStatesEqual( partLatRef, trajSim->partLattices_ );
//     trajSim->simulateTrajectory(0.79); checkSimLatticeConsistency();checkSimLatticeStatesEqual( trajStatesRef ); checkPartLatticeStatesEqual( partLatRef, trajSim->partLattices_ );
//     trajSim->simulateTrajectory(1.00); checkSimLatticeConsistency();checkSimLatticeStatesEqual( trajStatesRef ); checkPartLatticeStatesEqual( partLatRef, trajSim->partLattices_ );
//     trajSim->simulateTrajectory(0.54); checkSimLatticeConsistency();checkSimLatticeStatesEqual( trajStatesRef ); checkPartLatticeStatesEqual( partLatRef, trajSim->partLattices_ );
//     trajSim->simulateTrajectory(1.50); checkSimLatticeConsistency();checkSimLatticeStatesEqual( trajStatesRef ); checkPartLatticeStatesEqual( partLatRef, trajSim->partLattices_ );
// }
// 
// 
// ////////////////////////////////////////////--------------------------------------------------////////////////////////////////////////////
